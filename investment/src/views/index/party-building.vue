<template>
  <div class="building">
    <div class="zhong">
	  ...
	  <div class="img-box-d">
      	<img :src="dynamic[activeImg].coverImage" alt class="yi" @click.stop="$router.push('/Attracting-party/'+dynamic[activeImg].id)" :class="{'active':dh}">
	  </div>
      <div class="er">
        <img
          :src="item.coverImage"
          ...
          class="potor"
		      v-if="index < 4"
          @click.stop="$router.push('/Attracting-party/'+item.id)"
          @mouseenter="hoverChuange(index)"
        >
      </div>
        ...
        <div class="li">
          ...
          <el-collapse v-model="activeName" accordion>
            <el-collapse-item
              ...
              :title="item.title"
              :name="index"
              @click.native.stop="$router.push('/Attracting-party/'+item.id)"
            >
              <div>
