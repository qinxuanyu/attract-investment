		...
		<div class="list">
			...
			<ul class="box">
				<li 
					...
					:key="index"
				><router-link :to="'/Attracting-activities/'+item.id">{{item.title }}</router-link></li>
		...
		<div class="wrap">
			...
			<ol class="img-wrap">
				<li 
					...
					:key="index"
					v-if="index < 2"
					@click.stop="$router.push('/Attracting-activities/'+item.id)"
			...
			<div class="item">
			<ul class="text-list">
				<li v-for="(item,index) in interview[1]"
					:key="index"
				>
					<router-link :to="'/Attracting-activities/'+item.id">{{item.title}}</router-link>
				</li>
			...
			<ol class="img-wrap">
				<li 
					class="img-box-d"
					v-for="(item,index) in interview[1]"
					:key="index"
					v-if="index < 2"
					@click.stop="$router.push('/Attracting-activities/'+item.id)"
		...
		<div class="wrap">
			<div class="item">
				<ol class="img-wrap">
					<li 
						class="img-box-d"
						v-for="(item,index) in fieldVisit[0]"
						:key="index"
						v-if="index < 2"
						@click.stop="$router.push('/Attracting-activities/'+item.id)"
			...
			<ol class="img-wrap">
				<li 
					class="img-box-d"
					v-for="(item,index) in fieldVisit[1]"
					:key="index"
					v-if="index < 2"
					@click.stop="$router.push('/Attracting-activities/'+item.id)"
				>
